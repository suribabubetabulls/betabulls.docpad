...
if($_POST)
{
    $to_email       = "harsha.betabulls@gmail.com"; //Recipient email, Replace with own email here
    $from_email       = "info@betabulls.com"; //From email, most emails won't work without it.
